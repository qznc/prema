...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "nf0r5su4x4pz9282j8f5vxassakpwm1m7zpddcxaf1dc502tgha0",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Prema Prediction Market"),
    ...
    actions = [
      ...
      ( title = (defaultText = "New Marketplace"),
        command = .myCommand
    ...
    metadata = (
      ...
      website = "https://github.com/qznc/prema",
      # This should be the app's main website url.

      codeUrl = "https://github.com/qznc/prema",
      ...
      shortDescription = (defaultText = "Prediction market"),
